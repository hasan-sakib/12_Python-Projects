...
class Image:
    def __init__(self, x_pixels=0, y_pixels=0, num_channels=0, filename=''):
        ...
        self.input_path = '/Users/sakib/Projects/12 Python Projects/Photo Manipulation/input/'
        self.output_path = '/Users/sakib/Projects/12 Python Projects/Photo Manipulation/output/'
